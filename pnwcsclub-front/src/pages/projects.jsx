...
export default function Projects() {
    ...
    <>
        ...
        <body class=" text-center pb-8 h-screen bg-cream ">
            <h1 class="uppercase text-8xl font-title font-bold pt-8 text-dark-green tracking-wider"> projects</h1>
            <h3 class="mt-4 text-left ml-10 italic text-gray-700 font-body2">2024-2025</h3>
            <section class=" mx-10 ">
                <h2 class="text-4xl font-title font-bold pt-4">CS Club Website</h2>
            ...
            <section class=" mx-10 ">
                <h2 class="text-4xl font-title font-bold pt-8">Gatekeeper Project</h2>
                <p class="text-lg font-body pt-4">Project info...</p>
            </section>
            <section class=" mx-10 ">
                <h2 class="text-4xl font-title font-bold pt-8">Duckietown Project</h2>
                <p class="text-lg font-body pt-4">Project info...</p>
            </section>
        </body>
